...
- macOS: дважды кликни `/Users/kirkuz/Documents/New project/Start-App.command`
- Windows: дважды кликни `Start-App.bat`

Скрипты:
- автоматически проверяют Node.js (берут локальный `.local/node-current`, если есть),
- при необходимости запускают `npm install`,
- стартуют сервер и открывают [http://localhost:3000](http://localhost:3000).
